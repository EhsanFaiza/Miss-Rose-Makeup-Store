...
<head>
    ...
    <title>Lips Products - Miss Rose Makeup Store</title>
   ...
   <?php include 'header.php'; ?>
    ...
    <main>
        ...
        <div class="products-container">
            ...
            if ($conn) {
                // Query to fetch lips products from the database
                $query = "SELECT * FROM product WHERE Category = 'Lips'";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $productId = isset($row['ProductID']) ? htmlspecialchars($row['ProductID']) : 'unknown';
                        ...
                        echo '<label for="quantity-' . $productId . '">Quantity:</label>';
                        echo '<input type="number" id="quantity-' . $productId . '" name="quantity" value="1" min="1">';
                    ...
                    echo '<p>No lips products available at the moment.</p>';
                }
