...
<head>
    ...
    <title>Face Products - Miss Rose Makeup Store</title>
   ...
   <?php include 'header.php'; ?>
    ...
    <main>
        ...
        <div class="products-container">
            ...
            if ($conn) {
                // Query to fetch face products from the database
                $query = "SELECT * FROM product WHERE Category = 'Face'";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo '<p>No face products available at the moment.</p>';
                }
