...
<head>
    ...
    <title>MissRose International Products - Miss Rose Makeup Store</title>
...
<body>
   ...
   <?php include 'header.php'; ?>
    ...
    <main>
        <h2>MissRose International Products</h2>
        <div class="products-container">
            <?php
            // Check if the connection was successful
            if ($conn) {
                // Query to fetch eyes products from the database
                $query = "SELECT * FROM product WHERE Brand = 'MissRose International'";
